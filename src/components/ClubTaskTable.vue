<template>
  ...
  <q-table class="q-mx-lg no-shadow flat" :rows="tasks" :columns="columns" :rows-per-page-options="[5, 10, 20]">
    <template v-slot:body="props">
      <q-tr :props="props">
        <q-td v-if="props.row.first" @click="addNewTask" class="items-centered addNewTask">
