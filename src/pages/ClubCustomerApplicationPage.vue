<template>
  <q-page
    class="bg-dark-purple text-white column flex-center c-gutter-y-32"
    style="overflow: hidden; z-index: 0"
  >
    <section class="text-center">
      <h2 class="text-h2 q-mb-lg">Оставить заявку</h2>

      <span class="text-subtitle2">Расскажите нам о проекте, после мы свяжемся с вами</span>
    </section>
    ...
    <q-form class="form">
      <div class="c-gutter-y-32">
          ...
          <c-label-control class="col" label="Ваше имя" label-class="text-subtitle4">
            <template #control>
              <q-input
                ...
                class="c-input-outline-border-none bg-white"
              />
            </template>
          </c-label-control>

          <c-label-control class="col" label="Почта для связи">
            <template #control>
              <q-input
                v-model="form.email"
                borderless
        ...
        <section class="row c-gutter-x-32">
          <c-label-control class="col" label="Название компании">
            <template #control>
              <q-input
          ...
          <c-label-control class="col" label="Телефон для связи">
            <template #control>
              <q-input
                mask="+# (###) ###-##-##"
        ...
        <section class="row">
          <c-label-control class="col" label="Сообщение" control-style="height: 130px">
            <template #control>
              <q-input
                borderless
                autogrow
                ...
                type="textarea"
                class="c-input-outline-border-none gray-scrollbar-input c-input-area-mh bg-white"
              />
            </template>
          </c-label-control>
        </section>
        ...
        <section class="row c-gutter-x-32">
          <q-btn
            no-caps
            flat
            class="club-button-background text-subtitle4"
          ...
          <div class="flex no-wrap flex-center">
            <q-checkbox
              v-model="isAccept"
              class="c-checkbox-violet-6 c-checkbox-white-b c-checkbox-rounded"
            />
