...
// interface paginateOptions extends baseOptions {
//   only_one: Boolean;
// }

// function baseQuery(method_link: Function, variables: paginateVariables, options: paginateOptions) {
//   return method_link?.({
//     ...variables,
//     ...options,
...
// async function baseMutation(method_link: Function, variables: mutationVariables, options: baseOptions) {
...
// function extractPropertyData(result: Object | Object[], is_mutation = false) {
//   return result
...
//   static fetchApiPaginate(method_link, variables: paginateVariables, options: paginateOptions) {
